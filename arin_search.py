...
arin_html = requests.get('http://whois.arin.net/rest/ip/{formatted_ip_addr}'.format(formatted_ip_addr=ip))
...
if arin_html.status_code == 200:
    ...
    print '\nResults from: http://whois.arin.net/rest/ip/{formatted_ip_addr}'.format(formatted_ip_addr=ip)
else:
